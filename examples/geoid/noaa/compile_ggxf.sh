...
python3 ../../../scripts/GGXF.py -n write_cdl_header=true -v PRGEOID18-with-external-grid-ref.yaml -o PRGEOID18c.ggxf -y check_datasource_affine_coeffs=false  --dump-grid all prgeoid18c-grid.csv
